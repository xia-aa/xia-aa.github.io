---
title: The recommended i18n for TanStack Start
og:description: Type-safe i18n with tiny bundles. Fully integrated with TanStack Start and tested in TanStack's CI/CD pipeline.
og:image: https://inlang.com/tanstack-start-banner.svg
twitter:image: https://inlang.com/tanstack-start-banner.svg
description: Type-safe i18n with tiny bundles. Fully integrated with TanStack Start and tested in TanStack's CI/CD pipeline.
---

![Paraglide JS for TanStack Start overview](https://inlang.com/tanstack-start-banner.svg)
...
> [!NOTE]
> This example is mirrored from the official TanStack example in the [TanStack/router](https://github.com/TanStack/router/tree/main/examples/react/start-i18n-paraglide) repository.
